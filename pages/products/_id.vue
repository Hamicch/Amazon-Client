                  ...
                  <div class="centerCol">
                          ...
                          <div class="titleDiv">
                                  <h1 class="productTitle">
                                          ...
                                          <span class="smallTitle">Papperback</span>
                                  </h1>
                          </div>
                          <!-- Author's Name  -->
                                                  ...
                                                  <li class="swatchElement" style="width: 117px;">
                                                          <span class="a-list-item">
                                                                  <span class="a-buttom-toggle">
                                                                          <span class="a-button-inner">
                                                                                  <a href="#" class="a-button-text">
                                                                                          <span><img src="/img/audiblelogo.png" class="img-fluid" alt="audible-logo" style="width: 20px;"> Audible</span>
                                                                                          <br>
                                                                                          <span class="a-color-secondary">-</span>
                                                                                  </a>
                                                                          </span>
                                                  ...
                                                  <li class="swatchElement" style="width: 117px;">
                                                          <span class="a-list-item">
                                                                  <span class="a-buttom-toggle">
                                                                          <span class="a-button-inner">
                                                                                  <a href="#" class="a-button-text">
                                                                                          <span><img src="" alt="" class="img-fluid"> Paperback</span>
                                                                                          <br>
                                                                                          <span class="a-color-secondary">-</span>
                                                                                  </a>
                                                                          </span>
                                  ...
                                  <div class="row">
                                          <div class="col-sm-4 mb-1">
                                                  <div class="a-declarative">
                                                          length: <span><a href="#">336 pages <i class="a-icon a-icon-popover"></i></a></span>
                                                  </div>
                                          </div>
                                  </div>
                          </div>
            ...
            <div class="kcpAppBaseBox text-center">
              <img src="/img/readyondevice.png" class="img-fluid" />
                                ...
                                <div class="books-entity-teaser">
                                        <div class="bucket"><h2>More about the author</h2></div>
                                        <div class="content">
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-10 col-sm-8 col-8 pl-0">
                                                                <div class="mainContent">
                                                                        <h3>Biography</h3>
                                                                        <div class="authorBio">{{ product.owner.about }}</div>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
